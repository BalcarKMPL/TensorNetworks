...
if __name__ == '__main__':
    ...
    dir = "./BH_PEPS_LONGCUBICLINEARRAMP_" + str(dt) + str("_") + str(tQ) + str("_") + str(n)
    print("Saving in ", dir)
    ...
    def f(x):
        if x>=0: return 1+3/2*x
        return 1+3/2*x-1/2*x*x*x
    ...
    for i in range(0, n):
        ...
        print(Tools.estimated_time((i+1)/(n-1),t000))
