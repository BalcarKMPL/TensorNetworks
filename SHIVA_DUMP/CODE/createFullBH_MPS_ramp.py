...
if __name__ == '__main__':
    ...
    dir = "./BH_MPS_LONGCUBICRAMP_" + str(dt) + str("_") + str(tQ)
    print("Saving in ", dir)
    ...
    def Jramp(x):
        if x>=1: return 2 * J_crit
        return -J_crit / 2 * (x * x * x - 3 * x - 2)
