...
if __name__ == '__main__':
    ...
    while ififif:
        ififif=False
        for dir in ['./newcopy/BHNEW2_16_4_1.0_6.25_0.005_50', './newcopy/BHNEW2_16_4_1.0_17.5_0.005_100', './newcopy/BHNEW2_16_4_1.0_2.45_0.005_50', './newcopy/BHNEW2_16_4_1.0_8.75_0.005_100', './newcopy/BHNEW2_16_4_1.0_2.75_0.005_50', './newcopy/BHNEW2_16_4_1.0_17.5_0.005_100', './newcopy/BHNEW2_16_4_1.0_35.0_0.005_100', './newcopy/BHNEW2_16_4_1.0_70.0_0.005_100', './newcopy/BHNEW2_24_6_1.0_8.75_0.005_100', './newcopy/BHNEW2_32_8_1.0_8.75_0.005_100']:
            # for dir in ['./newcopy/BHNEW2_16_4_1.0_6.25_0.005_50', './newcopy/BHNEW2_16_4_1.0_17.5_0.005_100', './newcopy/BHNEW2_16_4_1.0_2.45_0.005_50', './newcopy/BHNEW2_16_4_1.0_8.75_0.005_100', './newcopy/BHNEW2_16_4_1.0_2.75_0.005_50', './newcopy/BHNEW2_16_4_1.0_17.5_0.005_100', './newcopy/BHNEW2_16_4_1.0_35.0_0.005_100', './newcopy/BHNEW2_16_4_1.0_70.0_0.005_100', './newcopy/BHNEW2_24_6_1.0_2.45_0.005_50', './newcopy/BHNEW2_24_6_1.0_2.75_0.005_50', './newcopy/BHNEW2_24_6_1.0_6.25_0.005_50', './newcopy/BHNEW2_24_6_1.0_8.75_0.005_100', './newcopy/BHNEW2_24_6_1.0_17.5_0.005_100', './newcopy/BHNEW2_24_6_1.0_35.0_0.005_100', './newcopy/BHNEW2_24_6_1.0_70.0_0.005_100', './newcopy/BHNEW2_32_8_1.0_8.75_0.005_100', './newcopy/BHNEW2_32_8_1.0_17.5_0.005_100', './newcopy/BHNEW2_32_8_1.0_35.0_0.005_100']:
            t000 = time()

            chi = int(float(dir.split('_')[1]))
            D = int(float(dir.split('_')[2]))
            J = (float(dir.split('_')[3]))
            U = (float(dir.split('_')[4]))
            dt = (float(dir.split('_')[5]))
            n = int(float(dir.split('_')[6]))
            CTMstep = 1
            ...
            # dir = "./BHNEW2_" + str(chi) + str("_") + str(D) + str("_") + str(J) + str("_") + str(U) + str("_") + str(dt) + str("_") + str(n)
            print("Saving in ", dir)
            print("Init params created")
            GATES = BoseHubbard.TrotterGate(d, r, dt / 2, J=J, U=U, mu=0)
            PEPS = {}
            for it in np.arange(100, 0, -1):
                sss = dir + '/PEPS_{:05d}.npz'.format(it)
                try:
                    PEPS = dict(np.load(sss))
                    break
                except:
                    continue
            if it >= 100:
            ...
            if i > 0:
                ...
                PEPS = NTU.__step(PEPS, ifprint=True, precision=NTUprecision, ifsvdu=ifsvdu, precisionspeed=NTUprecisionspeed, maxiter=maxiter, iffast=iffast)
                PEPS = NTU.__rot(PEPS)
                PEPS = NTU.__step(PEPS, ifprint=True, precision=NTUprecision, ifsvdu=ifsvdu, precisionspeed=NTUprecisionspeed, maxiter=maxiter, iffast=iffast)
                PEPS = NTU.__rot(PEPS)
                PEPS = NTU.__step(PEPS, ifprint=True, precision=NTUprecision, ifsvdu=ifsvdu, precisionspeed=NTUprecisionspeed, maxiter=maxiter, iffast=iffast)
